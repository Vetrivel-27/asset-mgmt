                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-yellow-100 text-yellow-700 text-sm font-bold">
                          {(() => {
                            ...
                            const actorName = actionEmployee?.name || (actionUser?.email ? actionUser.email.split('@')[0] : (actionUser?.userId || "Admin"));
                        ...
                        <div>
                          ...
                          <p className="text-sm font-bold text-slate-800">
                            {(() => {
                              ...
                              const actionUser = isRejected ? selectedRecord.statusChangedBy : selectedRecord.createdBy;
                              const actionEmployee = isRejected ? selectedRecord.statusChangedEmployee : selectedRecord.assignerEmployee;
                              return actionEmployee?.name || (actionUser?.email ? `${actionUser.email.split('@')[0]} (${actionUser.userId})` : (actionUser?.userId || "System Admin"));
                            })()}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="relative border-l border-slate-200 pl-5 ml-2 space-y-6">
                      ...
                      {selectedRecord.recordType === 'rejected_request' ? (
                        <div className="relative">
                          ...
                          <p className="text-xs text-slate-500 mt-1">
                            Rejected by <span className="font-semibold text-slate-700">{selectedRecord.statusChangedEmployee?.name || (selectedRecord.statusChangedBy?.email ? selectedRecord.statusChangedBy.email.split('@')[0] : (selectedRecord.statusChangedBy?.userId || "System Admin"))}</span>.
                          </p>
                        </div>
                      ) : (
                        <div className="relative">
                          ...
                          <p className="text-xs text-slate-500 mt-1">
                            Approved by <span className="font-semibold text-slate-700">{selectedRecord.assignerEmployee?.name || (selectedRecord.createdBy?.email ? selectedRecord.createdBy.email.split('@')[0] : (selectedRecord.createdBy?.userId || "System Admin"))}</span>.
                          </p>
