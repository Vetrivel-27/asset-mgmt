 ...
 *
 * @param {{ page: number, pageCount: number, setPage: function, canPrev: boolean,
 *           canNext: boolean, prev: function, next: function, showing: number,
 *           total: number, label?: string }} props
 */
function Pagination({
  page,
  pageCount,
